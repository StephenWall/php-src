...
#endif
#if defined(LDAP_OPT_X_TLS_OPENSSL_CONF)
	REGISTER_LONG_CONSTANT("LDAP_OPT_X_TLS_OPENSSL_CONF", LDAP_OPT_X_TLS_OPENSSL_CONF, CONST_PERSISTENT);
#endif
#if defined(LDAP_OPT_X_TLS_CERT_NAME_CHECK)
	REGISTER_LONG_CONSTANT("LDAP_OPT_X_TLS_CERT_NAME_CHECK", LDAP_OPT_X_TLS_CERT_NAME_CHECK, CONST_PERSISTENT);
#endif
#if defined(LDAP_OPT_X_TLS_OCSP_CHECK)
	REGISTER_LONG_CONSTANT("LDAP_OPT_X_TLS_OCSP_CHECK", LDAP_OPT_X_TLS_OCSP_CHECK, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("LDAP_OPT_X_TLS_OCSP_AIA_OVERRIDE", LDAP_OPT_X_TLS_OCSP_AIA_OVERRIDE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("LDAP_OPT_X_TLS_OCSP_NONCE", LDAP_OPT_X_TLS_OCSP_NONCE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("LDAP_OPT_X_TLS_OCSP_RESPONDER", LDAP_OPT_X_TLS_OCSP_RESPONDER, CONST_PERSISTENT);
#endif
